...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("LISTA ENCADEADA ESTÁTICA\n========================");
		
		System.out.println("\nTestes de tempo com a lista vazia\n---------------------------------");
		Trabalho01 lista1 = null; // <<----- CRIE O OBJETO DE SEU TRABALHO AQUI!
		lista1.criaLista(tamanho);
		Trabalho01 lista2 = null; // <<----- CRIE O OBJETO DE SEU TRABALHO AQUI!
